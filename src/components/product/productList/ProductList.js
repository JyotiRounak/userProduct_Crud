...
import { FILTER_PRODUCT, selectFilteredPoducts } from '../../../redux/features/product/filterSlice';
...
const ProductList = ({products, isLoading}) => {
    ...
    const filteredproduct = useSelector(selectFilteredPoducts);
                            ...
                            <tr key={_id}>
                                ...
                                <td className="icons">
                                    ...
                                    <Link to={`/product-detail/${_id}`}>
                                     <AiOutlineEye size={25} color={"pink"} />
                                     </Link>
                                    </span>
                                    <span>
